...
$sql = ' SELECT * FROM `latest_news1` LEFT JOIN latest_news1_kataterkait ON latest_news1_kataterkait.newsid=latest_news1.newsid WHERE    latest_news1.newsstatus  != \'Hidden\' AND   kataterkait LIKE '.$db->qstr('%Highlight%').'   AND latest_news1.newsid=\''.$newsid.'\'  limit 1  ';
$RS = $db->Execute($sql); 
if ($RS->fields['newsid'] != "")
{
                    ...
                    <div class="breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="highlight">Highlight</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Highlight Detail</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="row">
                            ...
                            <div class="post-item">
                                <div class="post-item-wrap">
                                    <div class="post-item-description">
										...
										$this_image		= get_image_gallery('highlight_big', $data_details['newsmainimage']);  
                    ...
                    <div class="sidebar sticky-sidebar col-lg-3">
                        <div class="widget">
                            	...
                            	<?php
                            	$sql = '  SELECT * FROM `latest_highlights` WHERE    newsid != \''.$data_details['newsid'].'\' AND newsstatus  != \'Hidden\' ORDER BY  `newsdate` DESC,   `newsid` DESC  limit 5  ';
								$RS = $db->Execute($sql); 
								if ($RS->fields['newsid'] != "")
								{	
									echo '<h4 class="widget-title">Recent Highlight</h4>
									...
									{ 
										...
										$link_detail 	= 'highlight/'.$RS->fields['newsid'].'/'.createPermaLink($RS->fields['newstitle_en']).'';
										$this_image		= get_image_gallery('highlight_thumb', $RS->fields['newsmainimage']);  
