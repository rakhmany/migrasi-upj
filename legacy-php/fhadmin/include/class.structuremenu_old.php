...
class fh_structuremenu extends dbcon {
	...
	function select_deep($parent, $prefix) {
        ...
        while (!$RS->EOF) 
         {  if ($tmp_flag1=="0") {
                $tmp_menu .=  "<tr class='bgviolet3'><td style='padding:2px 10px 2px 10px'>".$prefix.' '.$RS->fields['fh_menu_name']."</td>";
                ...
                $tmp_menu .=  "<tr class='bgwhite'><td style='padding:2px 10px 2px 10px'>".$prefix.' '.$RS->fields['fh_menu_name']."</td>";
                $tmp_menu .=  "<td class=wdth80 align=center>".$RS->fields["fh_strukturparenttipe"]."</td>";
                $tmp_menu .=  "<td class=wdth50 align=center><a href='". $_SERVER['PHP_SELF']."?action=up&coremenu=".$RS->fields["fh_strukturid"]."'><img src='../../images/arrow_top.gif'></a></td>";
                $tmp_menu .=  "<td class=wdth50 align=center><a href='". $_SERVER['PHP_SELF']."?action=down&coremenu=".$RS->fields["fh_strukturid"]."'><img src='../../images/arrow_down.gif'></a></td>";
                $tmp_menu .=  "<td class=wdth50 align=center><a href='". $_SERVER['PHP_SELF']."?action=detail&coremenu=".$RS->fields["fh_strukturid"]."'><img src='../../images/edit.gif'></a></td>";
	...
	function insert_menu($data_input, $data_files, $data_path, $data_width, $data_height) {
	    ...
	    {  if ($data_fh_strukturparenttipe == "Parent") {
              $SQL1 =  "INSERT INTO 		fh_struktur_menu (fh_strukturparent, fh_strukturparenttipe, fh_menu_name, fh_strukturstatus, fh_strukturtipe)
                              VALUES			    ('".$data_coremenu."', '".$data_fh_strukturparenttipe."', '".$data_fh_menu_name."', '','')";
           } else {
              if ($data_fh_strukturcontenttipe == "Module") {
                  $SQL1 =  "INSERT INTO 		fh_struktur_menu (fh_strukturparent, fh_strukturparenttipe, fh_menu_name, fh_strukturstatus, fh_strukturtipe, fh_modulefilename)
                                  VALUES			    ('".$data_coremenu."', '".$data_fh_strukturparenttipe."', '".$data_fh_menu_name."', '".$data_fh_strukturstatus."', '".$data_fh_strukturcontenttipe."', '".$data_fh_modulefilename."')";
              } else {
                  $SQL1 =  "INSERT INTO 		fh_struktur_menu (fh_strukturparent, fh_strukturparenttipe, fh_menu_name, fh_strukturstatus, fh_strukturtipe, fh_menu_pageheader, fh_menu_metakeyword, fh_menu_metadescription, fh_content_titlename, fh_content_description)
                                  VALUES			    ('".$data_coremenu."', '".$data_fh_strukturparenttipe."', '".$data_fh_menu_name."', '".$data_fh_strukturstatus."', '".$data_fh_strukturcontenttipe."', '".$data_fh_menu_pageheader."','".$data_fh_menu_metakeyword."','".$data_fh_menu_metadescription."','".$data_fh_content_title."', '".$data_fh_content_description."' )";
              }
		   }
