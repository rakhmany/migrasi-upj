...
<body class="">
                ...
                <section class="scrollable padder">              
                  <section class="row m-b-md">
                    <div class="col-sm-6">
                      ...
                      <small>{$smarty.now|date_format:"%A, %d-%B-%Y"}</small>
                    </div>
                      ...
                      <section class="panel b-a">
                        ...
                        <div class="panel-body">
                          ...
                          <div class="m-b">
                            ...
                            <a href="#" class="avatar thumb-sm">
                              <img src="{$themesurl_admin}images/a1.png" alt="...">
                              <i class="busy b-white"></i>
                            </a>
                            <a href="#" class="avatar thumb-sm">
                              <img src="{$themesurl_admin}images/a2.png" alt="...">
                              <i class="away b-white"></i>
                            </a>
                            <a href="#" class="avatar thumb-sm">
                              <img src="{$themesurl_admin}images/a3.png" alt="...">
                        ...
                        <div class="clearfix panel-footer">
                          ...
                          <a href="#" class="thumb-sm pull-left m-r">
                            <img src="{$themesurl_admin}images/a0.png" alt="..." class="img-circle">
                          </a>
                          <div class="clear">
                        ...
                        <ul class="list-group list-group-lg no-bg auto">                          
                          <a href="#" class="list-group-item clearfix">
                            <span class="pull-left thumb-sm avatar m-r">
                              <img src="{$themesurl_admin}images/a4.png" alt="...">
                          ...
                          <a href="#" class="list-group-item clearfix">
                            <span class="pull-left thumb-sm avatar m-r">
                              <img src="{$themesurl_admin}images/a5.png" alt="...">
                              <i class="on b-white bottom"></i>
                            </span>
                            <span class="clear">
                          ...
                          <a href="#" class="list-group-item clearfix">
                            <span class="pull-left thumb-sm avatar m-r">
                              <img src="{$themesurl_admin}images/a6.png" alt="...">
                          ...
                          <a href="#" class="list-group-item clearfix">
                            <span class="pull-left thumb-sm avatar m-r">
                              <img src="{$themesurl_admin}images/a7.png" alt="...">
                    ...
                    <li class="list-group-item">
                      <div class="media">
                        <span class="pull-left thumb-sm avatar">
                          <img src="{$themesurl_admin}images/a3.png" alt="..." class="img-circle">
  ...
  <!-- <script src="{$themesurl_admin}js/charts/easypiechart/jquery.easy-pie-chart.js"></script>
  <script src="{$themesurl_admin}js/charts/sparkline/jquery.sparkline.min.js"></script>
  <script src="{$themesurl_admin}js/charts/flot/jquery.flot.min.js"></script>
  <script src="{$themesurl_admin}js/charts/flot/jquery.flot.tooltip.min.js"></script>
  <script src="{$themesurl_admin}js/charts/flot/jquery.flot.spline.js"></script>
  <script src="{$themesurl_admin}js/charts/flot/jquery.flot.pie.min.js"></script>
  <script src="{$themesurl_admin}js/charts/flot/jquery.flot.resize.js"></script>
  <script src="{$themesurl_admin}js/charts/flot/jquery.flot.grow.js"></script>
  <script src="{$themesurl_admin}js/charts/flot/demo.js"></script> -->

  <script src="{$themesurl_admin}js/calendar/bootstrap_calendar.js"></script>
  <script src="{$themesurl_admin}js/calendar/demo.js"></script>
