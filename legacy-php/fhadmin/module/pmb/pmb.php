...
$tabel_config = "pmbconfig";
$primary_key_config = "pmbconfigid";

$nama_tpl = "pmb_";
$judul_halaman = "PMB Online";
$path_file_image = "../../../images/pmb/";

$optarray = enum("pmb.status");
$smarty->assign('optarray' , $optarray);
$optarray_jkel = enum("pmb.pmbjkel");
