            ...
            <section id="content">
                <section class="vbox">
                    <header class="header bg-white b-b clearfix">
                        <div class="row m-t-sm">
                            <div class="col-sm-5 m-b-xs">
                                ...
                                <span class="h5">{if $data_ks_id neq ''}Edit{else}Insert{/if} {$title}</span>
                            </div>
                    ...
                    <section class="scrollable wrapper w-f">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <ul class="breadcrumb">
                                    ...
                                    <li class="active"><i class="fa fa-pencil"></i> {if $data_ks_id neq ''}Edit{else}Insert{/if}</li>
                                </ul>
                                <!-- / .breadcrumb -->
                            </div>
                        </div>
                        ...
                        <form class="form-horizontal" data-validate="parsley" name="form" method="post" enctype="multipart/form-data" action="{$smarty.server.PHP_SELF}?data_ks_id={$data_ks_id}">
                            <div class="row">
                                <div class="col-sm-12">
                                    <section class="panel panel-default">
                                        ...
                                        <div class="panel-body">
                                                ...
                                                <div class="col-sm-3">
                                                    <select data-required="true" class="form-control" name="data_ks_status">
                                                        {section name=listing loop=$optarray}
                                                            <option value="{$optarray[listing]}"{if $data_ks_status eq $optarray[listing]} selected{/if}>{$optarray[listing]}</option>
                                                        {/section}
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="text" class="form-control" data-required="true" placeholder="title" name="data_ks_title" value="{$data_ks_title}">
                                                </div>
                                            </div>
                                            <div class="line line-dashed b-b line-lg pull-in"></div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="text" class="form-control" placeholder="http://" name="data_ks_url" value="{$data_ks_url}" data-type="url">
                                                </div>
                                            </div>
                                        </div>
                                    </section>
                                    ...
                                    <section class="panel panel-default">
                                        ...
                                        <div class="panel-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="file"{if $data_ks_id eq ''} data-required="true"{/if} class="filestyle" data-icon="false" data-classButton="btn btn-default" data-classInput="form-control inline v-middle input-s" name="data_ks_logo">
                                                    <br /><small>[Best dimensions : {$width}px x {$height}px]</small><br />
                                                    {if $data_ks_logo neq ''}
                                                        <div class="thumbnail m-t-xs">
                                                            <a href="{$path_file_image}{$data_ks_logo}"><img src="{$path_file_image}{$data_ks_logo}?{$smarty.now}" alt=""></a>
                                                            <div class="caption">
                                        ...
                                        <div class="panel-body">
                                            <div class="form-group">
                                                <div class="col-sm-4 col-sm-offset-2">
                                                    ...
                                                    {if $data_ks_id neq ''}
                                                        <input type="hidden" name="data_ks_id" value="{$data_ks_id}">
