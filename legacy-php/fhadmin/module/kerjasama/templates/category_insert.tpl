                    ...
                    <div class="panel-body">
	                      ...
	                      <div class="form-group">
	                        ...
	                        <div class="col-sm-6">
	                          <select name=data_cat_parent id="data_flexmenu_parent"  class="form-control"  >
								...
								<input  type="hidden" name="old_cat_parent" value="{$data_cat_parent}" />
								<input  type="hidden" name="old_priority" value="{$data_priority}" />
	                        </div>
	                      </div>
	                     </div>
	                    ...
	                    <div class="row">  
	                     ...
	                     <div class="row">  
	                      ...
	                      <div class="form-group">
	                        ...
	                        <div class="col-sm-6">
	                          <input  name="data_cat_title_en" value="{$data_cat_title_en}" type="text" class="form-control" >
	                        </div>
	                      </div>
	                     </div>   
	                    ...
	                    <div class="line line-dashed b-b line-lg pull-in"></div>
	                      <div class="form-group">
	                        ...
	                        <div class="col-sm-6">
	                          <input  type="checkbox" name="data_product_category_color" {if $data_product_category_color eq '1'} checked="checked"  {/if}  value="1" /> 
	                        </div>
	                      </div>
	                     </div> 
                    </div>
