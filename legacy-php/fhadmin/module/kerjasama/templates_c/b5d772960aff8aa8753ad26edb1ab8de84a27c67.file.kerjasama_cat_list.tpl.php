<?php /* Smarty version Smarty-3.1.17, created on 2023-09-24 01:23:13
         compiled from "templates\kerjasama_cat_list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:18390650f7361263715-38784639%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b5d772960aff8aa8753ad26edb1ab8de84a27c67' => 
    array (
      0 => 'templates\\kerjasama_cat_list.tpl',
      1 => 1692918963,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '18390650f7361263715-38784639',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_650f73612f3c01_00624492',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_650f73612f3c01_00624492')) {function content_650f73612f3c01_00624492($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include 'D:\\xampp\\htdocs\\upj2023\\fhadmin\\lib\\smarty\\plugins\\function.math.php';
...
$_smarty_tpl->tpl_vars['smarty']->value['section']['listing']['loop'] = is_array($_loop=$_smarty_tpl->tpl_vars['view']->value['data_cat_id']) ? count($_loop) : max(0, (int) $_loop); unset($_loop);
...
?>
						<tr>
                          <td><label class="checkbox m-n i-checks">
                              <input type="checkbox" name="delete[]" value="<?php echo $_smarty_tpl->tpl_vars['view']->value['data_cat_id'][$_smarty_tpl->getVariable('smarty')->value['section']['listing']['index']];?>
">
                              <i></i></label></td>
...
?action=detail&data_cat_id=<?php echo $_smarty_tpl->tpl_vars['view']->value['data_cat_id'][$_smarty_tpl->getVariable('smarty')->value['section']['listing']['index']];?>
"><?php echo $_smarty_tpl->tpl_vars['view']->value['data_cat_title'][$_smarty_tpl->getVariable('smarty')->value['section']['listing']['index']];?>
</a></td>
...
?chorder=down&amp;cat_id=<?php echo $_smarty_tpl->tpl_vars['view']->value['data_cat_id'][$_smarty_tpl->getVariable('smarty')->value['section']['listing']['index']];?>
">Down</a>
								<?php }?>
								...
								<?php if ($_smarty_tpl->getVariable('smarty')->value['section']['listing']['first']==false) {?>
									<a href="<?php $_smarty_tpl->smarty->_tag_stack[] = array('php', array()); $_block_repeat=true; echo smarty_php_tag(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
echo $_SERVER['PHP_SELF'];<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_php_tag(array(), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
?chorder=up&amp;cat_id=<?php echo $_smarty_tpl->tpl_vars['view']->value['data_cat_id'][$_smarty_tpl->getVariable('smarty')->value['section']['listing']['index']];?>
">Up</a>
								<?php }?>
							<?php }?>
						  </td>
                          <td class="text-center"><span class="label bg-<?php if ($_smarty_tpl->tpl_vars['view']->value['data_cat_status'][$_smarty_tpl->getVariable('smarty')->value['section']['listing']['index']]=='Hidden') {?>danger<?php } else { ?>success<?php }?>"><?php echo $_smarty_tpl->tpl_vars['view']->value['data_cat_status'][$_smarty_tpl->getVariable('smarty')->value['section']['listing']['index']];?>
</span></td>
