					...
					<table class="table table-striped m-b-none">
                      ...
                      <tbody>
						...
						<tr>
                          ...
                          <td class="text-center">{if $view.data_newsmainimage[listing] neq ''}<a href="{$smarty.server.PHP_SELF}?action=detail&data_newsid={$view.data_newsid[listing]}"><img src="{$path_file_image}{$view.data_newsmainimage[listing]}" style="width:120px;" alt="img" /></a>{else}no image{/if}</td>
                          ...
                          <td class="text-center"><a href="{$smarty.server.PHP_SELF}?action=detail&data_newsid={$view.data_newsid[listing]}" class="btn btn-default btn-xs btn-info"><i class="fa fa-pencil"></i> Edit</a></td>
                        </tr>
                        {/section}
                      </tbody>
                      <tfoot>
