<?php
/* Smarty version 3.1.31, created on 2017-09-22 09:32:27
  from "/home/upeje/public_html/fhadmin/module/manage_logo/templates/logo_list.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.31',
  'unifunc' => 'content_59c4763b13db69_12413838',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'd6b57e4cd6ab254aad4c4e26e14402414673d13b' => 
    array (
      0 => '/home/upeje/public_html/fhadmin/module/manage_logo/templates/logo_list.tpl',
      1 => 1502368987,
      2 => 'file',
    ),
  ),
...
function content_59c4763b13db69_12413838 (Smarty_Internal_Template $_smarty_tpl) {
...
$__section_listing_0_loop = (is_array(@$_loop=$_smarty_tpl->tpl_vars['view']->value['data_logoid']) ? count($_loop) : max(0, (int) $_loop));
...
?>
						<tr>
                          <td><label class="checkbox m-n i-checks">
                              <input type="checkbox" name="delete[]" value="<?php echo $_smarty_tpl->tpl_vars['view']->value['data_logoid'][(isset($_smarty_tpl->tpl_vars['__smarty_section_listing']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_listing']->value['index'] : null)];?>
">
                              <i></i></label></td>
...
?action=detail&data_logoid=<?php echo $_smarty_tpl->tpl_vars['view']->value['data_logoid'][(isset($_smarty_tpl->tpl_vars['__smarty_section_listing']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_listing']->value['index'] : null)];?>
"><?php echo $_smarty_tpl->tpl_vars['view']->value['data_logotitle'][(isset($_smarty_tpl->tpl_vars['__smarty_section_listing']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_listing']->value['index'] : null)];?>
</a></td>
                          <td class="text-center"><?php if ($_smarty_tpl->tpl_vars['view']->value['data_logofile'][(isset($_smarty_tpl->tpl_vars['__smarty_section_listing']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_listing']->value['index'] : null)] != '') {?><a class="fancybox" href="<?php echo $_smarty_tpl->tpl_vars['path_file_image']->value;
echo $_smarty_tpl->tpl_vars['view']->value['data_logofile'][(isset($_smarty_tpl->tpl_vars['__smarty_section_listing']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_listing']->value['index'] : null)];?>
"><img src="<?php echo $_smarty_tpl->tpl_vars['path_file_image']->value;
echo $_smarty_tpl->tpl_vars['view']->value['data_logofile'][(isset($_smarty_tpl->tpl_vars['__smarty_section_listing']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_listing']->value['index'] : null)];?>
" style="width:120px;" alt="img" /></a><?php } else { ?>no image<?php }?></td>
                          <td class="text-center"><span><a class="label bg-<?php if ($_smarty_tpl->tpl_vars['view']->value['data_logostatus'][(isset($_smarty_tpl->tpl_vars['__smarty_section_listing']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_listing']->value['index'] : null)] == 'Hidden') {?>danger<?php } else { ?>success<?php }?>" href="<?php echo $_SERVER['PHP_SELF']; ?>?action=view&status=show&data_logoid=<?php echo $_smarty_tpl->tpl_vars['view']->value['data_logoid'][(isset($_smarty_tpl->tpl_vars['__smarty_section_listing']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_listing']->value['index'] : null)];?>
" title="Hide / Show"><i class="fa fa-eye"></i> <?php echo $_smarty_tpl->tpl_vars['view']->value['data_logostatus'][(isset($_smarty_tpl->tpl_vars['__smarty_section_listing']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_listing']->value['index'] : null)];?>
</a></span></td>
