      ...
      <section id="content">
        <section class="vbox">
          <header class="header bg-white b-b clearfix">
			<div class="row m-t-sm">
			  <div class="col-sm-5 m-b-xs">
				...
				<span class="h5">{if $data_logoid neq ''}Edit{else}Insert{/if} {$title}</span>
			  </div>
          ...
          <section class="scrollable wrapper w-f">
            ...
            <div class="row">
				<div class="col-lg-12">
				  ...
				  <ul class="breadcrumb">
					...
					<li class="active"><i class="fa fa-pencil"></i> {if $data_logoid neq ''}Edit{else}Insert{/if}</li>
				  </ul>
				  <!-- / .breadcrumb -->
				</div>
            </div>
			...
			<form class="form-horizontal" data-validate="parsley" name="form" method="post" enctype="multipart/form-data" action="{$smarty.server.PHP_SELF}?data_logoid={$data_logoid}">
            <div class="row">
              <div class="col-sm-12">
                  <section class="panel panel-default">
                    ...
                    <div class="panel-body">
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="text" class="form-control" data-required="true" placeholder="title" name="data_logotitle" value="{$data_logotitle}">
                        </div>
                      </div>
                    </div>
                  </section>
                  ...
                  <section class="panel panel-default">
                    ...
                    <div class="panel-body">
                      <div class="form-group">
                        ...
                        <div class="col-sm-9">
						  <input type="file"{if $data_logoid eq ''} data-required="true"{/if} class="filestyle" data-icon="false" data-classButton="btn btn-default" data-classInput="form-control inline v-middle input-s" name="data_logofile">
                          <br /><small>[Width : {$width}px x {$height}px]</small><br />
						  {if $data_logofile neq ''}
						  <div class="thumbnail m-t-xs">
							<a href="#"><img src="{$path_file_image}{$data_logofile}" alt=""></a>
							<div class="caption">
                    ...
                    <div class="panel-body">
					  <div class="form-group">
						<div class="col-sm-4 col-sm-offset-2">
						  ...
						  {if $data_logoid neq ''}
						  <input type="hidden" name="data_logoid" value="{$data_logoid}">
