<?php /* Smarty version Smarty-3.1.17, created on 2023-10-13 02:35:09
         compiled from "templates/b_home_link_insert.tpl" */ ?>
<?php /*%%SmartyHeaderCode:72997981651be0ef72af94-77794182%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '98183e016bd1cc0a0e5dd80aca2b38313e3c1e73' => 
    array (
      0 => 'templates/b_home_link_insert.tpl',
      1 => 1697082803,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '72997981651be0ef72af94-77794182',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.17',
  'unifunc' => 'content_651be0ef785297_15744095',
  'variables' => 
  array (
    'data_homelink_id' => 0,
    'title' => 0,
    ...
    'msg' => 0,
    'optarray' => 0,
    'data_homelink_status' => 0,
    'data_homelink_date' => 0,
    'data_homelink_title' => 0,
    'data_homelink_title_en' => 0,
    'data_homelink_url' => 0,
    'width' => 0,
    'height' => 0,
    'data_homelink_pic' => 0,
...
<?php if ($_valid && !is_callable('content_651be0ef785297_15744095')) {function content_651be0ef785297_15744095($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/home/upeje/public_html/fhadmin/lib/smarty/plugins/modifier.date_format.php';
?><!DOCTYPE html>
...
" class="btn btn-sm btn-default m-r-xs" title="Back to main"><i class="fa fa-arrow-left"></i></a>
				<span class="h5"><?php if ($_smarty_tpl->tpl_vars['data_homelink_id']->value!='') {?>Edit<?php } else { ?>Insert<?php }?> <?php echo $_smarty_tpl->tpl_vars['title']->value;?>
</span>
			  </div>
...
"><i class="fa fa-list-ul"></i> <?php echo $_smarty_tpl->tpl_vars['title']->value;?>
					...
					<li class="active"><i class="fa fa-pencil"></i> <?php if ($_smarty_tpl->tpl_vars['data_homelink_id']->value!='') {?>Edit<?php } else { ?>Insert<?php }?></li>
				  </ul>
				  <!-- / .breadcrumb -->
				</div>
            </div>
...
?data_homelink_id=<?php echo $_smarty_tpl->tpl_vars['data_homelink_id']->value;?>
">
            <div class="row">
              <div class="col-sm-12">
...
"<?php if ($_smarty_tpl->tpl_vars['data_homelink_status']->value==$_smarty_tpl->tpl_vars['optarray']->value[$_smarty_tpl->getVariable('smarty')->value['section']['listing']['index']]) {?> selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['optarray']->value[$_smarty_tpl->getVariable('smarty')->value['section']['listing']['index']];?>
</option>
						  <?php endfor; endif; ?>
						  </select>
						  <input type="hidden" name="data_homelink_date" value="<?php echo $_smarty_tpl->tpl_vars['data_homelink_date']->value;?>
" />
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="text" class="form-control" data-required="true" name="data_homelink_title" value="<?php echo $_smarty_tpl->tpl_vars['data_homelink_title']->value;?>
">
                        </div>
                      </div>
                      <div class="line line-dashed b-b line-lg pull-in"></div>
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="text" class="form-control" data-required="true" name="data_homelink_title_en" value="<?php echo $_smarty_tpl->tpl_vars['data_homelink_title_en']->value;?>
">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="text" class="form-control" data-type="url" name="data_homelink_url" value="<?php echo $_smarty_tpl->tpl_vars['data_homelink_url']->value;?>
">
                        </div>
                      </div>
                  ...
                  <section class="panel panel-default">
                    ...
                    <div class="panel-body">
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
						  <input type="file"<?php if ($_smarty_tpl->tpl_vars['data_homelink_id']->value=='') {?> data-required="true"<?php }?> class="filestyle" data-icon="false" data-classButton="btn btn-default" data-classInput="form-control inline v-middle input-s" name="data_homelink_pic">
                          <br /><small>[Width : <?php echo $_smarty_tpl->tpl_vars['width']->value;?>
px x <?php echo $_smarty_tpl->tpl_vars['height']->value;?>
px]</small><br />
						  <?php if ($_smarty_tpl->tpl_vars['data_homelink_pic']->value!='') {?>
						  <div class="thumbnail m-t-xs">
							<a href="<?php echo $_smarty_tpl->tpl_vars['path_file_image']->value;?>
<?php echo $_smarty_tpl->tpl_vars['data_homelink_pic']->value;?>
...
" class="btn btn-default"><i class="fa fa-arrow-circle-left"></i> Cancel</a>
						  <?php if ($_smarty_tpl->tpl_vars['data_homelink_id']->value!='') {?>
						  <input type="hidden" name="data_homelink_id" value="<?php echo $_smarty_tpl->tpl_vars['data_homelink_id']->value;?>
">
