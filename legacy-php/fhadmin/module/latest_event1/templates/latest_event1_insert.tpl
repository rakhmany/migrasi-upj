      ...
      <section id="content">
        <section class="vbox">
          <header class="header bg-white b-b clearfix">
			<div class="row m-t-sm">
			  <div class="col-sm-5 m-b-xs">
				...
				<span class="h5">{if $data_eventid neq ''}Edit{else}Insert{/if} {$title}</span>
			  </div>
          ...
          <section class="scrollable wrapper w-f">
            ...
            <div class="row">
				<div class="col-lg-12">
				  ...
				  <ul class="breadcrumb">
					...
					<li class="active"><i class="fa fa-pencil"></i> {if $data_eventid neq ''}Edit{else}Insert{/if}</li>
				  </ul>
				  <!-- / .breadcrumb -->
				</div>
            </div>
			...
			<form class="form-horizontal" data-validate="parsley" name="form" method="post" enctype="multipart/form-data" action="{$smarty.server.PHP_SELF}?data_eventid={$data_eventid}">
            <div class="row">
              <div class="col-sm-12">
                  <section class="panel panel-default">
                    ...
                    <div class="panel-body">
                      <div class="form-group">
                        ...
                        <div class="col-sm-3">
                          <input class="datepicker-input form-control" type="text" data-required="true" placeholder="dd-mm-yyyy" name="data_eventdate" value="{$data_eventdate}" size="16" data-date-format="dd-mm-yyyy">
                        </div>
                        <label class="col-sm-1 control-label">Status</label>
                        <div class="col-sm-3">
                          <select data-required="true" class="form-control" name="data_eventstatus">
						  {section name=listing loop=$optarray_status}
							<option value="{$optarray_status[listing]}"{if $data_eventstatus eq $optarray_status[listing]} selected{/if}>{$optarray_status[listing]}</option>
						  {/section}
						  </select>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="text" class="form-control" data-required="true" placeholder="title" name="data_eventtitle" value="{$data_eventtitle}">
                        </div>
                      </div>
                      <div class="line line-dashed b-b line-lg pull-in"></div>
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="text" class="form-control" data-required="true" placeholder="title" name="data_eventtitle_en" value="{$data_eventtitle_en}">
                        </div>
                      </div>
                      <div class="line line-dashed b-b line-lg pull-in"></div>
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                         <textarea class="form-control" data-minlength="6" data-maxlength="255" rows="5" cols="50" name="data_eventshortdesc" id="data_eventshortdesc">{$data_eventshortdesc}</textarea>
                        </div>
                      </div>
                      <div class="line line-dashed b-b line-lg pull-in"></div>
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                         <textarea class="form-control" data-minlength="6" data-maxlength="255" rows="5" cols="50" name="data_eventshortdesc_en" id="data_eventshortdesc_en">{$data_eventshortdesc_en}</textarea>
                        </div>
                      </div>
                      <div class="line line-dashed b-b line-lg pull-in"></div>
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <textarea data-required="true" class="form-control jckeditor" name="data_eventdescription" id="data_eventdescription">{$data_eventdescription}</textarea>
                        </div>
                      </div>
                      <div class="line line-dashed b-b line-lg pull-in"></div>
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <textarea data-required="true" class="form-control jckeditor" name="data_eventdescription_en" id="data_eventdescription_en">{$data_eventdescription_en}</textarea>
                        </div>
                      </div>
                    </div>
                  </section>
                  ...
                  <section class="panel panel-default">
                    ...
                    <div class="panel-body">
                      <div class="form-group">
                        ...
                        <div class="col-sm-9">
						  <input type="file"{if $data_eventid eq ''} data-required="true"{/if} class="filestyle" data-icon="false" data-classButton="btn btn-default" data-classInput="form-control inline v-middle input-s" name="data_mainimage">
                          <br /><small>[Width : {$width}px x {$height}px]</small><br />
						  {if $data_eventmainimage neq ''}
						  <div class="thumbnail m-t-xs">
							<a href="{$path_image}{$data_eventmainimage}" target="_blank"><img src="{$path_image}thumb_{$data_eventmainimage}" alt=""></a>
							<div class="caption">
                    ...
                    <div class="panel-body">
					  <div class="form-group">
						<div class="col-sm-4 col-sm-offset-5">
						  ...
						  {if $data_eventid neq ''}
						  <input type="hidden" name="data_eventid" value="{$data_eventid}">
