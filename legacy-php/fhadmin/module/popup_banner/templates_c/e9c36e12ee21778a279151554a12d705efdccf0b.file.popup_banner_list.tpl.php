<?php /* Smarty version Smarty-3.1.17, created on 2026-04-02 15:46:08
         compiled from "templates/popup_banner_list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:838919485651a91a9d0ff28-02764920%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e9c36e12ee21778a279151554a12d705efdccf0b' => 
    array (
      0 => 'templates/popup_banner_list.tpl',
      1 => 1772074793,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '838919485651a91a9d0ff28-02764920',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.17',
  'unifunc' => 'content_651a91a9d87cd9_21098053',
  'variables' => 
  array (
    'title' => 0,
    'search' => 0,
...
<?php if ($_valid && !is_callable('content_651a91a9d87cd9_21098053')) {function content_651a91a9d87cd9_21098053($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/home/website/upjupjac/fhadmin/lib/smarty/plugins/function.math.php';
...
$_smarty_tpl->tpl_vars['smarty']->value['section']['listing']['loop'] = is_array($_loop=$_smarty_tpl->tpl_vars['view']->value['data_pbanner_id']) ? count($_loop) : max(0, (int) $_loop); unset($_loop);
...
?>
						<tr>
                          <td><label class="checkbox m-n i-checks">
                              <input type="checkbox" name="delete[]" value="<?php echo $_smarty_tpl->tpl_vars['view']->value['data_pbanner_id'][$_smarty_tpl->getVariable('smarty')->value['section']['listing']['index']];?>
">
                              <i></i></label></td>
...
.</td>
                          <td class="text-center"><?php echo $_smarty_tpl->tpl_vars['view']->value['data_pbanner_date'][$_smarty_tpl->getVariable('smarty')->value['section']['listing']['index']];?>
</td>
                          <td class="text-center"><?php echo $_smarty_tpl->tpl_vars['view']->value['data_pbanner_date_end'][$_smarty_tpl->getVariable('smarty')->value['section']['listing']['index']];?>
</td>
                          <td><a href="<?php echo $_SERVER['PHP_SELF'];?>
?action=detail&data_pbanner_id=<?php echo $_smarty_tpl->tpl_vars['view']->value['data_pbanner_id'][$_smarty_tpl->getVariable('smarty')->value['section']['listing']['index']];?>
"><?php echo $_smarty_tpl->tpl_vars['view']->value['data_pbanner_title'][$_smarty_tpl->getVariable('smarty')->value['section']['listing']['index']];?>
</a></td>
                          <td class="text-center"><?php if ($_smarty_tpl->tpl_vars['view']->value['data_pbanner_pic'][$_smarty_tpl->getVariable('smarty')->value['section']['listing']['index']]!='') {?><a class="fancybox" href="<?php echo $_smarty_tpl->tpl_vars['path_file_image']->value;?>
<?php echo $_smarty_tpl->tpl_vars['view']->value['data_pbanner_pic'][$_smarty_tpl->getVariable('smarty')->value['section']['listing']['index']];?>
...
?chorder=down&amp;pbanner_id=<?php echo $_smarty_tpl->tpl_vars['view']->value['data_pbanner_id'][$_smarty_tpl->getVariable('smarty')->value['section']['listing']['index']];?>
">Down</a>
								<?php }?>
								...
								<?php if ($_smarty_tpl->getVariable('smarty')->value['section']['listing']['first']==false) {?>
									<a href="<?php $_smarty_tpl->smarty->_tag_stack[] = array('php', array()); $_block_repeat=true; echo smarty_php_tag(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
echo $_SERVER['PHP_SELF'];<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_php_tag(array(), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
?chorder=up&amp;pbanner_id=<?php echo $_smarty_tpl->tpl_vars['view']->value['data_pbanner_id'][$_smarty_tpl->getVariable('smarty')->value['section']['listing']['index']];?>
">Up</a>
								<?php }?>
							<?php }?>
						  </td>
                          <td class="text-center"><span class="label bg-<?php if ($_smarty_tpl->tpl_vars['view']->value['data_pbanner_status'][$_smarty_tpl->getVariable('smarty')->value['section']['listing']['index']]=='Hidden') {?>danger<?php } else { ?>success<?php }?>"><?php echo $_smarty_tpl->tpl_vars['view']->value['data_pbanner_status'][$_smarty_tpl->getVariable('smarty')->value['section']['listing']['index']];?>
</span></td>
