<?php /* Smarty version Smarty-3.1.17, created on 2026-02-02 14:02:12
         compiled from "templates/b_banner_list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:9777753716816628f1b2241-25155613%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '279ef25524085fdba8b1a984ac78556fe44a683c' => 
    array (
      0 => 'templates/b_banner_list.tpl',
      1 => 1770009303,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '9777753716816628f1b2241-25155613',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.17',
  'unifunc' => 'content_6816628f24e9d7_45588469',
  'variables' => 
  array (
    'title' => 0,
    'search' => 0,
...
<?php if ($_valid && !is_callable('content_6816628f24e9d7_45588469')) {function content_6816628f24e9d7_45588469($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/home/website/upjupjac/fhadmin/lib/smarty/plugins/function.math.php';
...
$_smarty_tpl->tpl_vars['smarty']->value['section']['listing']['loop'] = is_array($_loop=$_smarty_tpl->tpl_vars['view']->value['data_bannerid']) ? count($_loop) : max(0, (int) $_loop); unset($_loop);
...
?>
						<tr>
                          <td><label class="checkbox m-n i-checks">
                              <input type="checkbox" name="delete[]" value="<?php echo $_smarty_tpl->tpl_vars['view']->value['data_bannerid'][$_smarty_tpl->getVariable('smarty')->value['section']['listing']['index']];?>
">
                              <i></i></label></td>
...
.</td>
                          <td class="text-center">
                              <?php echo $_smarty_tpl->tpl_vars['view']->value['data_bannerdate'][$_smarty_tpl->getVariable('smarty')->value['section']['listing']['index']];?>

                              <?php if ($_smarty_tpl->tpl_vars['view']->value['data_is_expired'][$_smarty_tpl->getVariable('smarty')->value['section']['listing']['index']]=='1') {?><small class="label label-danger">Expired</small><?php }?>
                          </td>
                          <td><a href="<?php echo $_SERVER['PHP_SELF'];?>
?action=detail&data_bannerid=<?php echo $_smarty_tpl->tpl_vars['view']->value['data_bannerid'][$_smarty_tpl->getVariable('smarty')->value['section']['listing']['index']];?>
"><?php echo $_smarty_tpl->tpl_vars['view']->value['data_bannertitle'][$_smarty_tpl->getVariable('smarty')->value['section']['listing']['index']];?>
 / <font color="red"><?php echo $_smarty_tpl->tpl_vars['view']->value['data_bannertitle_en'][$_smarty_tpl->getVariable('smarty')->value['section']['listing']['index']];?>
</font></a></td>
                          <td class="text-center"><?php if ($_smarty_tpl->tpl_vars['view']->value['data_bannerpic'][$_smarty_tpl->getVariable('smarty')->value['section']['listing']['index']]!='') {?><a class="fancybox" target="_blank" href="<?php echo $_smarty_tpl->tpl_vars['path_file_image']->value;?>
<?php echo $_smarty_tpl->tpl_vars['view']->value['data_bannerpic'][$_smarty_tpl->getVariable('smarty')->value['section']['listing']['index']];?>
...
?chorder=down&amp;bannerid=<?php echo $_smarty_tpl->tpl_vars['view']->value['data_bannerid'][$_smarty_tpl->getVariable('smarty')->value['section']['listing']['index']];?>
">Down</a>
								<?php }?>
								...
								<?php if ($_smarty_tpl->getVariable('smarty')->value['section']['listing']['first']==false) {?>
									<a href="<?php $_smarty_tpl->smarty->_tag_stack[] = array('php', array()); $_block_repeat=true; echo smarty_php_tag(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
echo $_SERVER['PHP_SELF'];<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_php_tag(array(), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
?chorder=up&amp;bannerid=<?php echo $_smarty_tpl->tpl_vars['view']->value['data_bannerid'][$_smarty_tpl->getVariable('smarty')->value['section']['listing']['index']];?>
">Up</a>
								<?php }?>
							<?php }?>
						  </td> -->
                          <td class="text-center"><?php echo $_smarty_tpl->tpl_vars['view']->value['data_bannertype'][$_smarty_tpl->getVariable('smarty')->value['section']['listing']['index']];?>
</td>
                          <td class="text-center"><?php echo $_smarty_tpl->tpl_vars['view']->value['data_bannerstatus'][$_smarty_tpl->getVariable('smarty')->value['section']['listing']['index']];?>
</td>
