      ...
      <section id="content">
        <section class="vbox">
          <header class="header bg-white b-b clearfix">
			<div class="row m-t-sm">
			  <div class="col-sm-12 m-b-xs">
				...
				<span class="h5">{if $data_galleryid neq ''}Edit{else}Insert{/if} {$title}</span>
			  </div>
			</div>
          </header>
          <section class="scrollable wrapper w-f">
            ...
            <div class="row">
				<div class="col-lg-12">
				  ...
				  <ul class="breadcrumb">
					...
					<li class="active"><i class="fa fa-pencil"></i> {if $data_galleryid neq ''}Edit{else}Insert{/if}</li>
				  </ul>
				  <!-- / .breadcrumb -->
				</div>
            </div>
			...
			<form class="form-horizontal" data-validate="parsley" name="form" method="post" enctype="multipart/form-data" action="{$smarty.server.PHP_SELF}{if $data_galleryid neq ''}?data_galleryid={$data_galleryid}{/if}">
            <div class="row">
              <div class="col-sm-12">
                  <section class="panel panel-default">
                    ...
                    <div class="panel-body">
                      <div class="form-group">
                        ...
                        <div class="col-sm-3">
                          <input class="datepicker-input form-control" type="text" data-required="true" placeholder="title" name="data_gallerydate" value="{$data_gallerydate}" size="16" data-date-format="dd-mm-yyyy">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="text" class="form-control" data-required="true" placeholder="Name" name="data_galleryname" value="{$data_galleryname}">
                        </div>
                      </div>
                      <div class="line line-dashed b-b line-lg pull-in"></div>
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="text" class="form-control" data-required="true" placeholder="Name" name="data_galleryname_en" value="{$data_galleryname_en}">
                        </div>
                      </div>
                      <div class="line line-dashed b-b line-lg pull-in"></div>
                      <div class="form-group">
                        ...
                        <div class="col-sm-3">
						  ...
						  {section name=listing loop=$optarray}
							<option value="{$optarray[listing]}"{if $data_gallerystatus eq $optarray[listing]} selected{/if}>{$optarray[listing]}</option>
						  {/section}
						  </select>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <textarea data-required="true" class="form-control jckeditor" name="data_gallerydescription" id="data_gallerydescription">{$data_gallerydescription}</textarea>
                        </div>
                      </div>
                      <div class="line line-dashed b-b line-lg pull-in"></div>
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <textarea data-required="true" class="form-control jckeditor" name="data_gallerydescription_en" id="data_gallerydescription_en">{$data_gallerydescription_en}</textarea>
                        </div>
                      </div> -->
                    </div>
                  </section>
                  ...
                  <section class="panel panel-default">
                    ...
                    <div class="panel-body">
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
						  <input type="file"{if $data_galleryid eq ''} data-required="true"{/if} class="filestyle" data-icon="false" data-classButton="btn btn-default" data-classInput="form-control inline v-middle input-s" name="data_galleryfilename">
                          {if $data_galleryfilename neq ''}
						  <div class="thumbnail m-t-xs">
							<a href="{$path_file_image}{$data_galleryfilename}" target="_blank"><img src="{$path_file_image}thumb_{$data_galleryfilename}" alt="Loading..."></a>
							<div class="caption">
                    ...
                    <div class="panel-body">
					  <div class="form-group">
						<div class="col-sm-4 col-sm-offset-2">
						  ...
						  {if $data_galleryid neq ''}
						  <input type="hidden" name="data_galleryid" value="{$data_galleryid}">
