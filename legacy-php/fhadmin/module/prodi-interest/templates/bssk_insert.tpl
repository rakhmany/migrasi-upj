	                   ...
	                   <div class="row">
	                      <div class="form-group">
	                        ...
	                        <div class="col-sm-6">
	                          ...
	                          <input   name="data_old_email" value="{$data_mainfieldname}" type="hidden"   >
                        	</div>
	                      </div>
	                  </div>
	                  <div class="row">
	                   <div class="line line-dashed b-b line-lg pull-in"></div>
	                      <div class="form-group">
	                        ...
	                        <div class="col-sm-6">
	                          <input   name="data_content_name_en" value="{$data_content_name_en}" type="text" class="form-control" data-required="true" > 
                        	</div>
	                      </div>
	                  </div>
	                </div>   
