				  ...
				  <div class="table-responsive">
					<table class="table table-striped m-b-none">
                      ...
                      <tbody>
						...
						{section name=listing loop=$view.fh_kategorimenuid_temp}
						<tr>
                          <td><label class="checkbox m-n i-checks">
                              <input type="checkbox" name="delete[]" value="{$view.fh_kategorimenuid_temp[listing]}">
                              <i></i></label></td>
                          <td class="text-center">{counter}.</td>
                          <td><a href="{$smarty.server.PHP_SELF}?action=detail&data_fh_kategorimenuid={$view.fh_kategorimenuid_temp[listing]}">{$view.fh_name_temp[listing]}</a></td>
                          <td class="text-center"><a href="{$smarty.server.PHP_SELF}?action=detail&data_fh_kategorimenuid={$view.fh_kategorimenuid_temp[listing]}" class="btn btn-default btn-xs btn-rounded btn-info"><i class="fa fa-pencil"></i> Edit</a></td>
                        </tr>
                        {/section}
                      </tbody>
                      <tfoot>
