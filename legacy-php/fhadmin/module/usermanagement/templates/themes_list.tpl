				  ...
				  <div class="table-responsive">
					<table class="table table-striped m-b-none">
                      ...
                      <tbody>
						...
						{section name=listing loop=$view.data_themesid}
						<tr>
                          <td><label class="checkbox m-n i-checks">
                              <input type="checkbox" name="delete[]" value="{$view.data_themesid[listing]}">
                              <i></i></label></td>
                          <!-- <td><a href="#modal" data-toggle="modal"><i class="fa fa-search-plus text-muted"></i></a></td> -->
                          <td class="text-center">{counter}.</td>
                          <td><a href="{$smarty.server.PHP_SELF}?action=detail&data_themesid={$view.data_themesid[listing]}">{$view.data_themesdir[listing]}</a></td>
                          <td class="text-center"><span><a class="label bg-{if $view.data_themesstatus[listing] eq 'Hidden'}danger{else}success{/if}" href="{$smarty.server.PHP_SELF}?action=view&status=show&data_themesid={$view.data_themesid[listing]}" title="Hide / Show"><i class="fa fa-eye"></i> {$view.data_themesstatus[listing]}</a></span></td>
                          <td class="text-center"><a href="{$smarty.server.PHP_SELF}?action=detail&data_themesid={$view.data_themesid[listing]}" class="btn btn-default btn-xs btn-rounded btn-info"><i class="fa fa-pencil"></i> Edit</a></td>
                        </tr>
                        {/section}
                      </tbody>
                      <tfoot>
