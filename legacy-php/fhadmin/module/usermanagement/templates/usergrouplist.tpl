                      ...
                      <tbody>
						...
						<tr>
                          <td><label class="checkbox m-n i-checks">
                              <input type="checkbox" name="delete[]" value="{$view.fh_usergroupid_temp[listing]}">
                              <i></i></label></td>
                          <td class="text-center">{counter}.</td>
						  <td>{$view.fh_usergroupid_temp[listing]}</td>
                          <td><a href="{$smarty.server.PHP_SELF}?action=detail&data_fh_usergroupid={$view.fh_usergroupid_temp[listing]}">{$view.fh_usergroupname_temp[listing]}</a></td>
                          <td class="text-center"><a href="{$smarty.server.PHP_SELF}?action=detail&&data_fh_usergroupid={$view.fh_usergroupid_temp[listing]}" class="btn btn-default btn-xs btn-rounded btn-info"><i class="fa fa-pencil"></i> Edit</a></td>
                        </tr>
                        {/section}
                      </tbody>
                      <tfoot>
