            ...
            <section id="content">
                <section class="vbox">
                    ...
                    <section class="scrollable wrapper w-f">
                        ...
                        <input type="text"   class="form-control" maxlength=255 name="fh_social_gplus" value="{$fh_social_gplus}">
                      </div>
                                    ...
                                    <section class="panel panel-default">
                                        ...
                                        <div class="panel-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <textarea class="form-control" name="fh_header_script" rows="3" cols="255">{$fh_header_script}</textarea>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <textarea class="form-control" name="fh_footer_script" rows="3" cols="255">{$fh_footer_script}</textarea>
                                    ...
                                    <section class="panel panel-default">
                                        ...
                                        <div class="panel-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    {if $fh_home_background neq ''}
                                                        <img src='{$path_image}{$fh_home_background}' style='width:400px;'><br>
                                                        {*<input type='submit'  value=' Delete General Banner ' name='delbanner' onclick='return konfirmasi()';><br><br>*}
                                                    {/if}
                                                    ...
                                                    <br><font color=red><b>Resize Image => Width : {$width_homebackground} px &nbsp;&nbsp;&nbsp; Height : {$height_homebackground} px</b></font>
                                                </div>
                                            </div>

                                            {*<div class="line line-dashed b-b line-lg pull-in"></div>
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">Home Quote</label>
                                                <div class="col-sm-9">
                                                    <textarea class="form-control" data-required="true" name="fh_home_quote" rows="4">{$fh_home_quote}</textarea>
                                                </div>
                                            </div>*}
                                        </div>
                                    </section>
