<?php /* Smarty version Smarty-3.1.17, created on 2025-05-02 07:50:44
         compiled from "templates/themes_list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:187470989868147954432fa7-26327892%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'beda8505f00b8191a33d32fd480192c366865627' => 
    array (
      0 => 'templates/themes_list.tpl',
      1 => 1697082803,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '187470989868147954432fa7-26327892',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_681479544cf785_39943328',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_681479544cf785_39943328')) {function content_681479544cf785_39943328($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/home/upeje/public_html/fhadmin/lib/smarty/plugins/function.math.php';
...
&search1=<?php echo $_smarty_tpl->tpl_vars['view']->value['search1'];?>
&search2=<?php echo $_smarty_tpl->tpl_vars['view']->value['search2'];?>
">Themes Directory<span class="th-sort"> <i class="fa fa-sort-down text<?php if ($_smarty_tpl->tpl_vars['view']->value['order']=='desc') {?>-active<?php }?>"></i> <i class="fa fa-sort-up text<?php if ($_smarty_tpl->tpl_vars['view']->value['order']=='asc') {?>-active<?php }?>"></i> <i class="fa fa-sort"></i> </span></a> </th>
...
$_smarty_tpl->tpl_vars['smarty']->value['section']['listing']['loop'] = is_array($_loop=$_smarty_tpl->tpl_vars['view']->value['data_themesid']) ? count($_loop) : max(0, (int) $_loop); unset($_loop);
...
?>
						<tr>
                          <td><label class="checkbox m-n i-checks">
                              <input type="checkbox" name="delete[]" value="<?php echo $_smarty_tpl->tpl_vars['view']->value['data_themesid'][$_smarty_tpl->getVariable('smarty')->value['section']['listing']['index']];?>
">
                              <i></i></label></td>
...
?action=detail&data_themesid=<?php echo $_smarty_tpl->tpl_vars['view']->value['data_themesid'][$_smarty_tpl->getVariable('smarty')->value['section']['listing']['index']];?>
"><?php echo $_smarty_tpl->tpl_vars['view']->value['data_themesdir'][$_smarty_tpl->getVariable('smarty')->value['section']['listing']['index']];?>
</a></td>
                          <td class="text-center"><span><a class="label bg-<?php if ($_smarty_tpl->tpl_vars['view']->value['data_themesstatus'][$_smarty_tpl->getVariable('smarty')->value['section']['listing']['index']]=='Hidden') {?>danger<?php } else { ?>success<?php }?>" href="<?php echo $_SERVER['PHP_SELF'];?>
?action=view&status=show&data_themesid=<?php echo $_smarty_tpl->tpl_vars['view']->value['data_themesid'][$_smarty_tpl->getVariable('smarty')->value['section']['listing']['index']];?>
" title="Hide / Show"><i class="fa fa-eye"></i> <?php echo $_smarty_tpl->tpl_vars['view']->value['data_themesstatus'][$_smarty_tpl->getVariable('smarty')->value['section']['listing']['index']];?>
</a></span></td>
