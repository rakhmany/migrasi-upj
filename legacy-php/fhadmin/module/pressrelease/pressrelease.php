...
/**************************************************************************
  ...
  * Tabel Latest_pressrelease dan Latest_pressrelease_kataterkait
...
$tabel_utama = "latest_pressrelease";
$primary_key = "newsid";

$tabel_ukuran = "latest_pressrelease_ukuran";
$primary_key_ukuran = "ukuranid";

$nama_tpl = "latest_pressrelease_";
$judul_halaman = "Latest pressrelease";
//$path_image = "../../../images/news/";
$path_image = BASE_DIR_UPLOAD_MODULE."pressrelease/";
$smarty->assign('path_file_image' , BASE_URL_UPLOAD_MODULE.'pressrelease/');
$smarty->assign('path_image' , BASE_URL_UPLOAD_MODULE.'pressrelease/');
		...
		if ($msg==""){ 
    		...
    		if (isset($_POST["insert"])){ 
                ...
                for($i=0;$i<count($data_kataterkait);$i++){
                    $SQL = "INSERT INTO `latest_pressrelease_kataterkait`  (".$primary_key.", `kataterkait`) 	
				...
				//*** Kata Terkait
				$SQL1 = "DELETE FROM		latest_pressrelease_kataterkait
                              WHERE			    ".$primary_key." = ".$data_newsid;
                $db->Execute($SQL1);
	...
	case "insert" :
	  ...
	  {   $data_newsid = $_GET["data_newsid"];
		    ...
		    if ($RS->fields["newsid"] == '') $msg = "There is no record in our database";
                ...
                $SQL = "SELECT      *
                             FROM         latest_pressrelease_kataterkait
