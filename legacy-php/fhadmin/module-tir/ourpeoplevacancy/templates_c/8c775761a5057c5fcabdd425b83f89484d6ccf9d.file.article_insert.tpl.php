<?php /* Smarty version Smarty-3.1.17, created on 2022-07-26 08:32:29
         compiled from "templates\article_insert.tpl" */ ?>
<?php /*%%SmartyHeaderCode:281775fb9f71f57eaa0-47171463%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '281775fb9f71f57eaa0-47171463',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.17',
  'unifunc' => 'content_5fb9f71f6311f9_71761288',
  'variables' => 
  array (
    'data_primarykey' => 0,
    'title' => 0,
    ...
    'best_image_view' => 0,
    'oldimage' => 0,
    'data_content_email' => 0,
    'themesurl_admin' => 0,
  ),
  'has_nocache_code' => false,
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5fb9f71f6311f9_71761288')) {function content_5fb9f71f6311f9_71761288($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'D:\\xampp\\htdocs\\cbm\\fhadmin\\lib\\smarty\\plugins\\modifier.date_format.php';
?><!DOCTYPE html>
...
" type="text" class="form-control datepicker-input"  data-date-format="dd-mm-yyyy" >
	                     ...
	                     <div class="line line-dashed b-b line-lg pull-in"></div>
	                      <div class="form-group">
	                        <label class="col-sm-2 control-label">Short description (ID)</label>
	                        <div class="col-sm-6">
	                          <textarea  name="data_content_short_id"  class="form-control" ><?php echo $_smarty_tpl->tpl_vars['data_content_short_id']->value;?>
</textarea>
	                        </div>
	                      </div>
	                     </div>
	                     ...
	                     <div class="line line-dashed b-b line-lg pull-in"></div>
	                      <div class="form-group">
	                        ...
	                        <div class="col-sm-6">
	                          <textarea  name="data_content_short_en"  class="form-control" ><?php echo $_smarty_tpl->tpl_vars['data_content_short_en']->value;?>
</textarea>
	                        </div>
	                      </div>
	                     </div>
	                     ...
	                     <div class="line line-dashed b-b line-lg pull-in"></div>
	                      <div class="form-group">
	                        ...
	                        <div class="col-sm-6">
	                          <input  name="data_content_email" value="<?php echo $_smarty_tpl->tpl_vars['data_content_email']->value;?>
" type="text" class="form-control" >
	                        </div>
	                      </div>
	                     </div>
