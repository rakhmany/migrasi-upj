	                    ...
	                    <div class="row">
	                     ...
	                     <div class="line line-dashed b-b line-lg pull-in"></div>
	                      <div class="form-group">
	                        ...
	                        <div class="col-sm-6">
	                          <textarea  name="data_content_short_id"  class="form-control" >{$data_content_short_id}</textarea>
	                        </div>
	                      </div>
	                     </div>
	                     <div class="row hidden ">
	                     <div class="line line-dashed b-b line-lg pull-in"></div>
	                      <div class="form-group">
	                        ...
	                        <div class="col-sm-6">
	                          <textarea  name="data_content_short_en"  class="form-control" >{$data_content_short_en}</textarea>
	                        </div>
	                      </div>
	                     </div>
	                     <div class="row  ">
	                     ...
	                     <div class="line line-dashed b-b line-lg pull-in"></div>
	                      <div class="form-group">
	                        ...
	                        <div class="col-sm-6">
	                          <input  name="data_content_email" value="{$data_content_email}" type="text" class="form-control" >
	                        </div>
	                      </div>
	                     </div>
                    </div>
