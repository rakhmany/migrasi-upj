<?php /* Smarty version Smarty-3.1.17, created on 2023-05-18 01:31:27
                      ...
                      <div class="row">
	                      ...
	                      <div class="form-group">
	                        <label class="col-sm-2 control-label">Position (ID)</label>
		                        <div class="col-sm-10">
		                          <input   name="data_d_content_longdesc_id" value="<?php echo $_smarty_tpl->tpl_vars['data_d_content_longdesc_id']->value;?>
" type="text" class="form-control" data-required="true" >
	                        	</div>
                      ...
                      <div class="row">
	                      <div class="line line-dashed b-b line-lg pull-in"></div>
	                      <div class="form-group">
	                        <label class="col-sm-2 control-label">Position (EN)</label>
		                        <div class="col-sm-10">
		                          <input   name="data_d_content_longdesc_en" value="<?php echo $_smarty_tpl->tpl_vars['data_d_content_longdesc_en']->value;?>
" type="text" class="form-control" data-required="true" >
	                        	</div> 
	                      </div>
                      </div> 
