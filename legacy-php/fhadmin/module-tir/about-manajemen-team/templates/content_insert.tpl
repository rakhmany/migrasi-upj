                      ...
                      <div class="row">
	                      ...
	                      <div class="form-group">
	                        <label class="col-sm-2 control-label">Position (ID)</label>
		                        <div class="col-sm-10">
		                          <input   name="data_d_content_longdesc_id" value="{$data_d_content_longdesc_id}" type="text" class="form-control" data-required="true" >
	                        	</div>
                      ...
                      <div class="row">
	                      ...
	                      <div class="form-group">
	                        <label class="col-sm-2 control-label">Position (EN)</label>
		                        <div class="col-sm-10">
		                          <input   name="data_d_content_longdesc_en" value="{$data_d_content_longdesc_en}" type="text" class="form-control" data-required="true" >
	                        	</div> 
	                      </div>
                      </div> 
