<?php /* Smarty version Smarty-3.1.17, created on 2023-03-22 00:54:50
         compiled from "templates\content_insert.tpl" */ ?>
<?php /*%%SmartyHeaderCode:64055fb9e4f17df8e7-36425281%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '64055fb9e4f17df8e7-36425281',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.17',
  'unifunc' => 'content_5fb9e4f196c891_98027063',
  'variables' => 
  array (
    'data_primarykey' => 0,
    'title' => 0,
...
<?php if ($_valid && !is_callable('content_5fb9e4f196c891_98027063')) {function content_5fb9e4f196c891_98027063($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_options')) include 'D:\\xampp\\htdocs\\tira\\fhadmin\\lib\\smarty\\plugins\\function.html_options.php';
                      ...
                      <div class="row">
	                      ...
	                      <div class="form-group">
	                        <label class="col-sm-2 control-label">Description (ID)</label>
		                        <div class="col-sm-10">
		                          <textarea class="form-control  " name="data_d_content_longdesc_id" id="data_d_content_longdesc_id"><?php echo $_smarty_tpl->tpl_vars['data_d_content_longdesc_id']->value;?>
</textarea>
		                        </div>
	                      </div>
                      </div>
                      <div class="row">
	                      ...
	                      <div class="form-group">
	                        <label class="col-sm-2 control-label">Description (EN)</label>
		                        <div class="col-sm-10">
		                          <textarea class="form-control  " name="data_d_content_longdesc_en" id="data_d_content_longdesc_en"><?php echo $_smarty_tpl->tpl_vars['data_d_content_longdesc_en']->value;?>
</textarea>
		                        </div>
	                      </div>
                      </div> 
                    ...
                    <div class="panel-body"> 
                      <div class="row   ">
						  <div class="form-group">
						    ...
						    <div class="col-sm-6">
						      <div>
						        <input type="text" class="icon-class-input hidden" name="data_d_content_icon" value="<?php echo $_smarty_tpl->tpl_vars['data_d_content_icon']->value;?>
" />
