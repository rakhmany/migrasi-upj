<?php /* Smarty version Smarty-3.1.17, created on 2023-04-02 17:28:01
         compiled from "templates\content_list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:90885fc902b7da69a6-67849374%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '41b433d1fc5c7aa87ba904fd1c6ad5dd7cd2152d' => 
    array (
      0 => 'templates\\content_list.tpl',
      1 => 1680449278,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '90885fc902b7da69a6-67849374',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.17',
  'unifunc' => 'content_5fc902b80276d6_30238888',
  'variables' => 
  array (
    'systemname' => 0,
    'option_cat_val' => 0,
...
<?php if ($_valid && !is_callable('content_5fc902b80276d6_30238888')) {function content_5fc902b80276d6_30238888($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_options')) include 'D:\\xampp\\htdocs\\tira\\fhadmin\\lib\\smarty\\plugins\\function.html_options.php';
if (!is_callable('smarty_function_math')) include 'D:\\xampp\\htdocs\\tira\\fhadmin\\lib\\smarty\\plugins\\function.math.php';
        ...
        <section class="hbox stretch">
          ...
          <aside>
            <section class="vbox">
              ...
              <form method="post" class=" pull-right t form-inline " style="margin-top: 10px;" action="<?php echo $_SERVER['PHP_SELF'];?>
">
                <select class="input-sm form-control" name="search_category">
                <?php echo smarty_function_html_options(array('values'=>$_smarty_tpl->tpl_vars['option_cat_val']->value,'selected'=>$_smarty_tpl->tpl_vars['search_category']->value,'output'=>$_smarty_tpl->tpl_vars['option_cat_name']->value),$_smarty_tpl);?>
 
                </select>  
                    
                    <input type="text" id="search" name="search" value="<?php echo $_smarty_tpl->tpl_vars['view']->value['search'];?>
					...
					<table class="table table-striped m-b-none">
                      <thead>
                        ...
                        <tr>
                         ...
                         <th  > 
                          <?php echo $_smarty_tpl->tpl_vars['mainfieldnamed']->value;?>
...
'>
                          ...
                          <td   ><?php echo $_smarty_tpl->tpl_vars['view']->value['gennews_statname_temp'][$_smarty_tpl->getVariable('smarty')->value['section']['listing']['index']];?>
</td>
                          <td   ><?php echo $_smarty_tpl->tpl_vars['view']->value['mainfieldname_temp'][$_smarty_tpl->getVariable('smarty')->value['section']['listing']['index']];?>
                           ...
                           <td class="text-center"><?php echo $_smarty_tpl->tpl_vars['view']->value['this_priority_temp'][$_smarty_tpl->getVariable('smarty')->value['section']['listing']['index']];?>
</td>
...
" class="btn btn-default btn-xs   btn-info" style="margin: 3px;clear: both;"><i class="fa fa-pencil"></i> Edit</a></td>
                        </tr>
                        <?php endfor; endif; ?>
                      </tbody>
                      <tfoot>
...
<script>
function show_price(i, e, v)
{
	var retVal = prompt("Masukkan harga baru : ");
	if(Number(retVal) > 0 )
	{ 
		$("."+i+"price_"+e).append('<img src="loading.gif" alt="loading..." id="loading_stat"  />');
		$.post("change_price.php", { i: ""+i+"", e: ""+e+"" , o: ""+v+"" , v: ""+retVal+"" }, 
	    function(data){
	     	$("."+i+"price_"+e).html(data);
	    });
	}
	else
	{
