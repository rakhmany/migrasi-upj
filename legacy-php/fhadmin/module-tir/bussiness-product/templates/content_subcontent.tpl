            ...
            <section class="vbox">
              ...
              <section class="scrollable wrapper w-f">
					...
					<a href="?action=gallery&data_primarykey={$data_primarykey}" class="btn btn-primary" >Gallery</a>
					 <a href="?action=subcontent&data_primarykey={$data_primarykey}" class="btn btn-primary" >Our Services</a>
					 
					{/if}
			
			 
				<form name=form method=post enctype="multipart/form-data"  action={php}echo $_SERVER['PHP_SELF']; {/php}{if $data_primarykey neq ''}?action=subcontent&data_primarykey={$data_primarykey}{/if}>
			                    ...
			                    <div class="panel-body">
				                     ...
				                     <div class="row">
				                      ...
				                      <div class="form-group">
				                        ...
				                        <div class="col-sm-6"> 
				                          <textarea   name="data_gallery_description_id" class="form-control">{$data_gallery_description_id}</textarea>
				                      ...
				                      <div class="form-group">
				                        ...
				                        <div class="col-sm-6"> 
				                          <textarea   name="data_gallery_description_en" class="form-control">{$data_gallery_description_en}</textarea>
				  ...
				  <div class="table-responsive">
					<table class="table table-striped m-b-none">
                      ...
                      <tbody>
						...
						<tr> 
                          <td> {$gallery.gallery_gallery_image[listing]}</td>
                          <td>{$gallery.gallery_gallery_name_id[listing]}<br />
                          {$gallery.gallery_gallery_description_id[listing]}
                          </td>
