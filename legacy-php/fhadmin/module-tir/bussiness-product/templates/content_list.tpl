        ...
        <section class="hbox stretch">
          ...
          <aside>
            <section class="vbox">
              ...
              <form method="post" class=" pull-right t form-inline " style="margin-top: 10px;" action="{$smarty.server.PHP_SELF}">
                <select class="input-sm form-control" name="search_category">
                {html_options values=$option_cat_val selected=$search_category output=$option_cat_name} 
                </select>  
                    
                    <input type="text" id="search" name="search" value="{$view.search}" class="input-sm form-control" placeholder="Search">
					...
					<table class="table table-striped m-b-none">
                      ...
                      <tbody>
						...
						<tr>
                          ...
                          <td   >{$view.gennews_statname_temp[listing]}</td>
                          <td   >{$view.mainfieldname_temp[listing]}</td>
                          
                           <td class="text-center">{$view.this_priority_temp[listing]}</td>
                          <td class="text-center">
                           <a href="{$smarty.server.PHP_SELF}?action=detail&data_primarykey={$view.primarykey_temp[listing]}" class="btn btn-default btn-xs   btn-info" style="margin: 3px;clear: both;"><i class="fa fa-pencil"></i> Edit</a></td>
                        </tr>
                        {/section}
                      </tbody>
                      <tfoot>
