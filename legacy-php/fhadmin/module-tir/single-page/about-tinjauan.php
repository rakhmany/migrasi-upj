...
{	
	...
	{ 
	  ...
	  //if ($data_mainimage2['name'] == "" && $old_mainimagename2 == "" && $requiremainimage === true) { $msg.="Please input Image 2<br>";}
		  ...
		  if($handle->uploaded) {
			  if($handle->file_is_image)
			  {
					  ...
					  if ($handle->processed) {
						  ...
						  $handle->image_resize = true;
						  $handle->file_overwrite = true;
						  $handle->image_x = $imagethumbsize_x2;
						  $handle->image_y = $imagethumbsize_y2;
						  $handle->file_new_name_body = 'thumb_'.$thumb_name;
