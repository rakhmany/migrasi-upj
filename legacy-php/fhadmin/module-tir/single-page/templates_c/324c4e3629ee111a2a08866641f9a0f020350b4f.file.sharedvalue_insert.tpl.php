<?php /* Smarty version Smarty-3.1.17, created on 2023-04-02 09:30:56
         compiled from "templates\sharedvalue_insert.tpl" */ ?>
<?php /*%%SmartyHeaderCode:3001664292f308bd988-95223265%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '324c4e3629ee111a2a08866641f9a0f020350b4f' => 
    array (
      0 => 'templates\\sharedvalue_insert.tpl',
      1 => 1680420651,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '3001664292f308bd988-95223265',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_64292f30b0cf41_02655467',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_64292f30b0cf41_02655467')) {function content_64292f30b0cf41_02655467($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'D:\\xampp\\htdocs\\tira\\fhadmin\\lib\\smarty\\plugins\\modifier.date_format.php';
?><!DOCTYPE html>
...
"><i class="fa fa-list-ul"></i> <?php echo $_smarty_tpl->tpl_vars['title']->value;?>
			...
			<?php }?>
			<?php if ($_smarty_tpl->tpl_vars['pesan_sukses']->value!='') {?>
			<div class="alert alert-success">
			  <button type="button" class="close" data-dismiss="alert">x</button>
			  <i class="fa fa-ok-sign"></i><?php echo $_smarty_tpl->tpl_vars['pesan_sukses']->value;?>
...
" type="text" class="form-control datepicker-input"  data-date-format="dd-mm-yyyy" >
	                     ...
	                     <div class="line line-dashed b-b line-lg pull-in"></div>
	                      <div class="form-group">
	                        ...
	                        <div class="col-sm-6">
	                        	<textarea class="form-control" name="data_content_short_id" id="data_content_short_id"><?php echo $_smarty_tpl->tpl_vars['data_content_short_id']->value;?>
</textarea>
	                        </div> 
	                      </div>
	                     </div>
	                     ...
	                     <div class="line line-dashed b-b line-lg pull-in"></div>
	                      <div class="form-group">
	                        ...
	                        <div class="col-sm-6">
	                        	<textarea class="form-control" name="data_content_short_en" id="data_content_short_en"><?php echo $_smarty_tpl->tpl_vars['data_content_short_en']->value;?>
</textarea>
	                        </div>  
	                      </div>
	                     </div>
	                     ...
	                     <div class="line line-dashed b-b line-lg pull-in"></div>
	                      <div class="form-group">
	                        ...
	                        <div class="col-sm-10">
	                          <textarea class="form-control  " name="data_content_long_en" id="data_content_long_en"><?php echo $_smarty_tpl->tpl_vars['data_content_long_en']->value;?>
</textarea>
	                        </div>
	                      </div>
	                     </div>  
	                     ...
	                     <div class="line line-dashed b-b line-lg pull-in"></div>
	                      <div class="form-group">
	                        ...
	                        <div class="col-sm-10">
	                          <textarea class="form-control  " name="data_content_long_id" id="data_content_long_id"><?php echo $_smarty_tpl->tpl_vars['data_content_long_id']->value;?>
</textarea>
	                        </div>
	                      </div>
	                     </div>
	                     <div class="row hidden">
	                      ...
	                      <div class="form-group">
	                        ...
	                        <div class="col-sm-6">
	                          ...
	                          <span style="color: red;"><?php echo $_smarty_tpl->tpl_vars['best_image_view2']->value;?>
</span>
	                         </div>
	                        </div> 
	                      </div>
	                     ...
	                     <div class="line line-dashed b-b line-lg pull-in"></div>
	                      <div class="form-group">
	                        ...
	                        <div class="col-sm-6">
	                          <input  name="data_content_link" value="<?php echo $_smarty_tpl->tpl_vars['data_content_link']->value;?>
" type="text" class="form-control" >
	                        </div>
	                      </div>
	                     </div>
...
<?php if ($_smarty_tpl->tpl_vars['ckeditor_reloaded']->value=='1') {?>
	<script>
	location.reload();
	</script>
<?php }?>
