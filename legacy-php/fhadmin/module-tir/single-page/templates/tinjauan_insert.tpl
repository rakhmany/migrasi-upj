                    ...
                    <div class="panel-body">
	                     ...
	                     <div class="line line-dashed b-b line-lg pull-in"></div>
	                      <div class="form-group">
	                        ...
	                        <div class="col-sm-10">
	                          <textarea class="form-control  " name="data_content_long_en" id="data_content_long_en">{$data_content_long_en}</textarea>
	                        </div>
	                      </div>
	                     </div>  
	                     <div class="row ">
	                     <div class="line line-dashed b-b line-lg pull-in"></div>
	                      <div class="form-group">
	                        ...
	                        <div class="col-sm-10">
	                          <textarea class="form-control  " name="data_content_long_id" id="data_content_long_id">{$data_content_long_id}</textarea>
	                        </div>
	                      </div>
	                     </div>
	                     <div class="row ">
	                      ...
	                      <div class="form-group">
	                        ...
	                        <div class="col-sm-6">
	                          ...
	                          <span style="color: red;">{$best_image_view2}</span>
	                         </div>
	                        </div> 
	                      </div>
	                      {$oldimage2}
