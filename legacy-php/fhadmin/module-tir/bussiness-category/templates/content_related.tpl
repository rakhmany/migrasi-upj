      ...
      <section id="content">
        <section class="hbox stretch">
          ...
          <aside>
			...
			<form name=form method=post enctype="multipart/form-data"  action={php}echo $_SERVER['PHP_SELF']; {/php}{if $data_primarykey neq ''}?action=related&data_primarykey={$data_primarykey}{/if}>
			                    ...
			                    <div class="panel-body">
				                      ...
				                      <div class="form-group">
				                        ...
				                        <select  class="form-control"  name="data_gallery_name"   >
				                                 {html_options values=$option_subcat_val selected=$data_gallery_name output=$option_subcat_name} 
			                            </select> 
                        				</div>
				                      </div>
				                     </div>
