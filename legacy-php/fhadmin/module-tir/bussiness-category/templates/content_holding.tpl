      ...
      <section id="content">
        <section class="hbox stretch">
          ...
          <aside>
			...
			<form name=form method=post enctype="multipart/form-data"  action={php}echo $_SERVER['PHP_SELF']; {/php}{if $data_primarykey neq ''}?action=holding&data_primarykey={$data_primarykey}{/if}>
			                    ...
			                    <div class="panel-body">
				                     ...
				                     <div class="row">
				                      ...
				                      <div class="form-group">
				                        ...
				                        <div class="col-sm-6"> 
				                          <input   name="data_gallery_image" value="{$data_gallery_image}" type="text" class="form-control" data-required="true" >
				  ...
				  <div class="table-responsive">
					<table class="table table-striped m-b-none">
                      ...
                      <tbody>
						...
						<tr> 
                          <td> {$gallery.gallery_gallery_name[listing]}</td>
