      ...
      <section id="content">
        <section class="vbox">
          <header class="header bg-info b-b clearfix">
			<div class="row m-t-sm">
			  <div class="col-sm-5 m-b-xs">
				...
				<span class="h5">{if $data_fh_menuid neq ''}Edit{else}Insert{/if} {$title}</span>
			  </div>
          ...
          <section class="scrollable wrapper w-f">
            ...
            <div class="row">
				<div class="col-lg-12">
				  ...
				  <ul class="breadcrumb">
					...
					<li class="active"><i class="fa fa-pencil"></i> {if $data_fh_menuid neq ''}Edit{else}Insert{/if}</li>
				  </ul>
				  <!-- / .breadcrumb -->
				</div>
            </div>
			...
			<form class="form-horizontal" data-validate="parsley" name="form" method="post" enctype="multipart/form-data" action="{$smarty.server.PHP_SELF}?data_fh_menuid={$data_fh_menuid}">
            <div class="row">
              <div class="col-sm-12">
                  <section class="panel panel-default">
                    ...
                    <div class="panel-body">
                      <div class="form-group">
                        <label class="col-sm-2 control-label">Menu ID</label>
                        <div class="col-sm-6">
                          {$data_fh_menuid}
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="text" class="form-control" data-required="true" placeholder="Name" name="data_fh_name" value="{$data_fh_name}">
                        </div>
                      </div>
                      <div class="line line-dashed b-b line-lg pull-in"></div>
                      <div class="form-group">
                        ...
                        <div class="col-sm-5">
                          <select class="form-control chosen-select" name="data_fh_kategorimenuid" style="width:100%">
							{section name=list loop=$menukategoriid}  
								<option value="{$menukategoriid[list]}"
								{if $data_fh_kategorimenuid eq $menukategoriid[list]}selected{/if}
								>{$menuname[list]}</option>
							{/section}
						  </select>
                        </div>
                      </div>
                    ...
                    <div class="panel-body">
					  <div class="form-group">
						<div class="col-sm-4 col-sm-offset-2">
						  ...
						  <input type="hidden" name="data_fh_menuid" value="{$data_fh_menuid}">
