...
// 	  	      $data_content_permalink = createPermaKey($maintable, $RS->fields['content_title_en'] );
// 	  	      $db->Execute("UPDATE ".$maintable." SET	  content_permalink=".$db->qstr($data_content_permalink)." WHERE ".$primarykey." = ".$RS->fields[$primarykey]);
// 	  	      
	  	      $RS->MoveNext();
	  	  }
