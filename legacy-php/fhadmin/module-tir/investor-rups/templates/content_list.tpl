                      ...
                      <tbody>
						...
						<tr>
                         ...
                         <td class="text-center">
                           <a href="{$smarty.server.PHP_SELF}?action=gallery&data_primarykey={$view.primarykey_temp[listing]}" class="btn btn-default btn-xs   btn-info" style="margin: 3px;clear: both;"><i class="fa fa-pencil"></i> PDF</a></td>
