...
$sql = ' SELECT * FROM `latest_pressrelease` WHERE   newsstatus  != \'Hidden\' AND newsid=\''.$newsid.'\'  limit 1  ';
$RS = $db->Execute($sql); 
if ($RS->fields['newsid'] != "")
{
                    ...
                    <div class="breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Press Release Detail</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                            ...
                            <div class="post-item">
                                <div class="post-item-wrap">
                                    <div class="post-item-description">
										...
										$this_image		= get_image_gallery('pressrelease_big', $data_details['newsmainimage']);  
                    ...
                    <div class="sidebar sticky-sidebar col-lg-3">
                        <div class="widget">
                            <?php
                            	$sql = '  SELECT * FROM `latest_pressrelease` WHERE    newsid != \''.$data_details['newsid'].'\' AND newsstatus  != \'Hidden\' ORDER BY  `newsdate` DESC,   `newsid` DESC  limit 5  ';
								$RS = $db->Execute($sql); 
								if ($RS->fields['newsid'] != "")
								{	
									echo '<h4 class="widget-title">Others Press Release</h4>
