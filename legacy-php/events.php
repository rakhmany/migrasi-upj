        ...
        <section id="page-content">
            <div class="container">
                ...
                <div id="blog" class="grid-layout post-3-columns m-b-30" data-item="post-item">
                	...
                	<?php
                    $sql = ' SELECT * FROM `latest_event1` WHERE    eventstatus  != \'Hidden\' ORDER BY  `eventdate` DESC,   `eventid` DESC ';
					$RS = $db->Execute($sql); 
					if ($RS->fields['eventid'] != "")
					{
						...
						$sql = '  SELECT * FROM `latest_event1` WHERE    eventstatus  != \'Hidden\' ORDER BY  `eventdate` DESC,   `eventid` DESC  limit '.$pagination['from'].',  '.$perpage.'  ';
						$RS = $db->Execute($sql); 
						if ($RS->fields['eventid'] != "")
						{		
							while (!$RS->EOF)  
